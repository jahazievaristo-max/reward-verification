...
if run_mode == 'slc_prizes':
    ...
    raffle_seed = 'Silencio_Raffle_Season4:SLC33%-Airdrop30%-Burn19%-DePIN18%-SLC:'

prize_assignment = pd.read_csv(input_prize_matrix)
total_prize_quantity = prize_assignment['prize_quantity'].sum()
# get user data
user_data = pd.read_csv('silencio_raffle_eligible_users_june_2025.csv', dtype={'raffle_tickets': 'int64'})
