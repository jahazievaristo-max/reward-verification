...
The raffle seed is generated based on the results of a [community poll conducted on the Silencio X account](https://x.com/silencioNetwork/status/1950548649408184612), resulting in the following seed string. The digits used in the seed are the rounded numbers found in the mobile X app:

![community_seed_vote.jpg](community_seed_vote.jpg)

- **For SLC Prizes:**
  ```
  'Silencio_Raffle_Season6:Silence64%-Frequency16%-Signal10%-Vibration10%-SLC:'
  ```
...
├── silencio_raffle_eligible_users_august_2025.csv  # Eligible users with raffle tickets
...
2. Apply a sha256 Checksum to any of the following files (**generate sha256 file checksum**) and validate against the hashes stored on this file `raffle-season-6/hashed_files_raffle_airdrop_august_2025.txt`: 
- `silencio_raffle_eligible_users_august_2025.csv`
